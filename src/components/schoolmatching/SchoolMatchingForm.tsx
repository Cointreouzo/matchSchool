...
export default function SchoolMatchingForm({
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border-0 p-10 hover:shadow-3xl transition-all duration-300 mb-8 w-4/5 mx-auto">
